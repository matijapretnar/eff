...
let h1 = ((fun (x1) -> (fun (x2) -> ((fun (x) -> (Value ((fun (coer_refl_x) -> (coer_refl_x)) (x)))) ((x1) (Value ((fun (x) -> (Value ((fun (coer_refl_x) -> (coer_refl_x)) (x)))) (x2))))))) ((handler {value_clause = (fun (y) -> (Value ((fun (coer_refl_x) -> (coer_refl_x)) (let x = ((fun (coer_refl_x) -> (coer_refl_x)) (y)) in (0))))); effect_clauses = (fun (type a) (type b) (x : (a, b) effect) -> ((match x with | Dummy -> (fun (_ : a) (l : b -> _ computation) -> (Value ((fun (coer_refl_x) -> (coer_refl_x)) (3)))) | eff' -> (fun arg k -> Call (eff', arg, k))) : a -> (b -> _ computation) -> _ computation)) }))) in ((fun (x) -> ((match (x) with | Value (y) -> ((fun (coer_refl_x) -> (coer_refl_x)) (y)) ))) (((fun (x1) -> (fun (x2) -> ((fun (x) -> (Value ((fun (coer_refl_x) -> (coer_refl_x)) (x)))) ((x1) (Value ((fun (x) -> (Value ((fun (coer_refl_x) -> (coer_refl_x)) (x)))) (x2))))))) (h1)) ((fun (x) -> (Value ((fun (coer_refl_x) -> (coer_refl_x)) (x)))) (((fun (coer_x1) -> (fun (coer_x2) -> ((fun (x) -> (Value ((fun (coer_refl_x) -> (coer_refl_x)) (x)))) ((coer_x1) ((fun (coer_refl_x) -> (coer_refl_x)) (coer_x2)))))) (effect Dummy)) (())))))