...
let _bigTestLoop_140 (_num_141 : int) =
  let rec _interp_142 _x_184 =
    match _x_184 with
    | Num _b_213 -> Value _b_213
    | Add (_l_215, _r_214) ->
        _interp_142 _l_215 >> fun _x_216 ->
        _interp_142 _r_214 >> fun _y_217 -> Value (_x_216 + _y_217)
    | Mul (_l_220, _r_219) ->
        _interp_142 _l_220 >> fun _x_221 ->
        _interp_142 _r_219 >> fun _y_222 -> Value (_x_221 * _y_222)
    | Sub (_l_225, _r_224) ->
        _interp_142 _l_225 >> fun _x_226 ->
        _interp_142 _r_224 >> fun _y_227 -> Value (_x_226 - _y_227)
    | Div (_l_230, _r_229) -> (
        _interp_142 _r_229 >> fun _y_231 ->
        _interp_142 _l_230 >> fun _x_232 ->
        match _y_231 with
        | 0 -> Call (DivByZero, (), fun (_y_233 : int) -> Value _y_233)
        | _ -> Value (_x_232 / _y_231))
  in
...
let _testState_242 (_n_243 : int) =
  let rec _interp_244 _x_285 =
    match _x_285 with
    | Num _b_297 ->
        Call (Set, _b_297 * _b_297, fun (_y_300 : unit) -> Value _b_297)
    | Add (_l_302, _r_301) ->
        _interp_244 _l_302 >> fun _x_303 ->
        _interp_244 _r_301 >> fun _y_304 -> Value (_x_303 + _y_304)
    | Mul (_l_307, _r_306) ->
        _interp_244 _l_307 >> fun _x_308 ->
        _interp_244 _r_306 >> fun _y_309 -> Value (_x_308 * _y_309)
    | Sub (_l_312, _r_311) ->
        _interp_244 _l_312 >> fun _x_313 ->
        _interp_244 _r_311 >> fun _y_314 -> Value (_x_313 - _y_314)
    | Div (_l_317, _r_316) -> (
        _interp_244 _r_316 >> fun _y_318 ->
        _interp_244 _l_317 >> fun _x_319 ->
        match _y_318 with
        | 0 -> Call (Get, (), fun (_y_320 : int) -> Value _y_320)
        | _ -> Value (_x_319 / _y_318))
  in
...
let _testStateLoop_340 (_n_341 : int) =
  ...
  in
  let rec _interp_358 _x_413 =
    match _x_413 with
    | Num _b_449 ->
        Call (Set, _b_449 * _b_449, fun (_y_452 : unit) -> Value _b_449)
    | Add (_l_454, _r_453) ->
        _interp_358 _l_454 >> fun _x_455 ->
        _interp_358 _r_453 >> fun _y_456 -> Value (_x_455 + _y_456)
    | Mul (_l_459, _r_458) ->
        _interp_358 _l_459 >> fun _x_460 ->
        _interp_358 _r_458 >> fun _y_461 -> Value (_x_460 * _y_461)
    | Sub (_l_464, _r_463) ->
        _interp_358 _l_464 >> fun _x_465 ->
        _interp_358 _r_463 >> fun _y_466 -> Value (_x_465 - _y_466)
    | Div (_l_469, _r_468) -> (
        _interp_358 _r_468 >> fun _y_470 ->
        _interp_358 _l_469 >> fun _x_471 ->
        match _y_470 with
        | 0 -> Call (Get, (), fun (_y_472 : int) -> Value _y_472)
        | _ -> Value (_x_471 / _y_470))
  in
