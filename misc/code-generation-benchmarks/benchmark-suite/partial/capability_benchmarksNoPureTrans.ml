...
let rec _op_42 (* @ *) _x_49 (_ys_51 : triple_int_list) =
  ...
  | TripleCons (_x_53, _xs_52) ->
      ...
      Value (_b_54 _ys_51) >>= fun _b_55 -> TripleCons (_x_53, _b_55)
...
let _testTriple_56 (_n_57 : int) (_s_58 : int) =
  let rec _choice_679 _x_680 =
    ...
    if _x_682 then TripleNil
        ...
        if _y_687 then
          ...
          let rec _choice_690 _x_691 =
            ...
            if _x_693 then TripleNil
                ...
                if _y_698 then
                  ...
                  let rec _choice_701 _x_702 =
                    ...
                    if _x_704 then TripleNil
                      ...
                      Value (_op_42 (* @ *) _xs_706) >>= fun _b_708 ->
                      _b_708 _ys_707
                  in
                  _choice_701 _x_700
                else
              ...
              Value (_op_42 (* @ *) _xs_695) >>= fun _b_697 -> _b_697 _ys_696
          in
          _choice_690 _x_689
        else
      ...
      in
      Value (_l_683 true) >>= fun _xs_684 ->
      Value (_l_683 false) >>= fun _ys_685 ->
...
let rec _filter_727 _x_736 (_x_738 : intlist) =
  ...
  | Lst (_x_740, _xs_739) ->
      ...
      if _b_741 then
        ...
        Value (_b_742 _xs_739) >>= fun _b_743 -> Lst (_x_740, _b_743)
...
let rec _forall_745 _x_752 (_x_754 : queen_list) =
  ...
  | Cons (_x_756, _xs_755) ->
      ...
      _b_757 && Value (_forall_745 _x_752) >>= fun _b_758 -> _b_758 _xs_755
...
let _no_attack_759 ((_x_760, _y_761) : int * int)
  ...
  && Value (( <> ) _y_761) >>= fun _b_767 ->
     Value (_b_767 _y'_763) >>= fun _b_766 ->
     _b_766
     && Value (( - ) _x_760) >>= fun _b_771 ->
        ...
        Value (abs _b_773) >>= fun _b_772 -> _b_768 _b_772
...
let _available_775 (_x_776 : int) (_qs_777 : queen_list) (_l_778 : intlist) =
  Value
    (_filter_727 (fun (_y_780 : int) ->
         ...
         Value (_forall_745 _b_782) >>= fun _b_781 -> _b_781 _qs_777))
...
let _testGenerator_1173 (_n_1174 : int) =
  Value
    (let rec _generateFromTo_1266 (_l_1176, _u_1177) =
       ...
       if _x_1332 then fun (_s_1333 : int) -> _s_1333
       else fun (_s_1334 : int) ->
