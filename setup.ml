...
(* OASIS_START *)
(* DO NOT EDIT (digest: 526768bc0b715d42afb3d851b10f32cc) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         {
            OCamlbuildCommon.plugin_tags =
              Some "package(js_of_ocaml.ocamlbuild)";
            extra = ["-use-ocamlfind"]
         };
     test = [];
     doc = [];
            ...
            [
               Executable
                 ({
                      ...
                      bs_data_files =
                        [
                           ...
                           ("../src/backends/multicore/multicorePervasives.eff",
                             None);
                           ("../src/backends/noeff/noEffPervasives.eff",
                             None)
                        ];
                   ...
                   {exec_custom = false; exec_main_is = "main/eff.ml"})
            ];
     ...
     oasis_digest =
       Some "\135\250\246\162\182\218\157\153\172\131\2141\014 \205B";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
