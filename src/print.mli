...
val pattern : ?max_level:int -> Pattern.t -> Format.formatter -> unit
val pattern_list : ?max_length:int -> Pattern.t -> Format.formatter -> unit
val region_param :
...
val let_abstraction :
  Pattern.t * Core.computation -> Format.formatter -> unit
