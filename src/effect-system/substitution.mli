...
val apply_substitutions_to_constraints : t -> Typed.omega_ct list -> Typed.omega_ct list
(** [apply_substitutions_to_constraints subs constraints] Applies all substitutions from [subs] to [constraints] *)

val apply_substitutions_to_computation : t -> Typed.computation -> Typed.computation
(** [apply_substitutions_to_computation subs computation] Applies all substitutions from [subs] to [computation] *)

val apply_substitutions_to_expression : t -> Typed.expression -> Typed.expression
