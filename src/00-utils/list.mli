...
(** [equal eq [a1; ...; an] [b1; ..; bm]] holds when the two input lists have
    ...
    position we have [eq ai bi]. Note: the [eq] function may be called even if
    the lists have different length. If you know your equality function is
    costly, you may want to check {!compare_lengths} first. Natively available
    in: 4.12.0 *)
