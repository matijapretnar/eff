...
let _no_attack_20 (_x_21, _y_22) (_x'_23, _y'_24) =
  if _x_21 <> _x'_23 then
    if _y_22 <> _y'_24 then _abs_9 (_x_21 - _x'_23) <> _abs_9 (_y_22 - _y'_24)
    else false
  else false
...
let rec _not_attacked_36 _x'_37 _gen_function_38 =
  ...
  | [] -> true
  | _x_39 :: _xs_40 ->
      if _no_attack_20 _x'_37 _x_39 then _not_attacked_36 _x'_37 _xs_40
      else false

let _available_44 (_number_of_queens_45, _x_46, _qs_47) =
  let rec _loop_48 (_possible_49, _y_50) =
    if _y_50 < 1 then _possible_49
    else if _not_attacked_36 (_x_46, _y_50) _qs_47 then
      _loop_48 (_y_50 :: _possible_49, _y_50 - 1)
  ...
  handler
    {
      value_clause =
        (fun _y_76 ->
          value (fun _lift_fun_238 -> value ((fun _ -> _y_76) _lift_fun_238)));
      effect_clauses =
        (fun (type a b) (x : (a, b) effect) : (a -> (b -> _) -> _) ->
          match x with
          | Effect_Decide ->
...
let _queens_83 _number_of_queens_84 =
  let rec _place_85 (_x_86, _qs_87) =
    if _x_86 > _number_of_queens_84 then value _qs_87
    else
...
let _queens_one_option_94 _number_of_queens_95 =
  let rec _place_17 (_x_14, _qs_13) =
    if _x_14 > _number_of_queens_95 then Some _qs_13
    else
...
let _queens_one_cps_96 _number_of_queens_97 =
  let rec _place_86 (_x_83, _qs_82) =
    if _x_83 > _number_of_queens_97 then fun _lift_fun_239 ->
      value ((fun _ -> _qs_82) _lift_fun_239)
    else
...
let _queens_all_100 _number_of_queens_101 =
  let rec _place_173 (_x_170, _qs_169) =
    if _x_170 > _number_of_queens_101 then [ _qs_169 ]
    else
