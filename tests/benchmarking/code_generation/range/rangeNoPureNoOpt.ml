...
let _failwith_10 _msg_11 =
  (effect Effect_Failure) _msg_11 >> fun _gen_bind_12 -> _absurd_8 _gen_bind_12
...
let _mod_18 _m_19 =
  value (fun _n_20 ->
      ...
      | 0 ->
          ...
          _absurd_8 _gen_bind_21
      | _n_22 -> _mod_17 _m_19 >> fun _gen_bind_23 -> _gen_bind_23 _n_22)
...
let _var_31 (* / *) _m_32 =
  value (fun _n_33 ->
      ...
      | 0 ->
          ...
          _absurd_8 _gen_bind_34
      | _n_35 -> _var_29 (* / *) _m_32 >> fun _gen_bind_36 -> _gen_bind_36 _n_35)
...
let rec _assoc_41 _x_42 =
  value (fun _gen_function_43 ->
      ...
      | [] -> value None
      | (_y_44, _z_45) :: _lst_46 -> (
          (_var_1 (* = *) _x_42 >> fun _gen_bind_48 -> _gen_bind_48 _y_44)
          >> fun _gen_bind_47 ->
          match _gen_bind_47 with
          | true -> value (Some _z_45)
          | false -> _assoc_41 _x_42 >> fun _gen_bind_49 -> _gen_bind_49 _lst_46
          ))
...
let rec _range_52 _m_53 =
  value (fun _n_54 ->
      ...
      >> fun _gen_bind_55 ->
      match _gen_bind_55 with
      | true -> value []
      | false ->
          let _r_57 = _range_52 in
          ( ( (_var_14 (* + *) _m_53 >> fun _gen_bind_61 -> _gen_bind_61 1)
            >> fun _gen_bind_60 -> _r_57 _gen_bind_60 )
          >> fun _gen_bind_59 -> _gen_bind_59 _n_54 )
          >> fun _gen_bind_58 -> value (_m_53 :: _gen_bind_58))
...
let rec _map_62 _f_63 =
  value (fun _gen_function_64 ->
      ...
      | _x_65 :: _xs_66 ->
          ...
          (_map_62 _f_63 >> fun _gen_bind_69 -> _gen_bind_69 _xs_66)
...
let _take_71 _f_72 =
  value (fun _k_73 ->
      (_range_52 0 >> fun _gen_bind_75 -> _gen_bind_75 _k_73) >> fun _r_74 ->
      _map_62 _f_72 >> fun _gen_bind_76 -> _gen_bind_76 _r_74)
...
let rec _fold_left_77 _f_78 =
  value (fun _a_79 ->
      value (fun _gen_function_80 ->
          ...
          | [] -> value _a_79
          | _y_81 :: _ys_82 ->
              (_f_78 _a_79 >> fun _gen_bind_84 -> _gen_bind_84 _y_81)
              >> fun _a_83 ->
              (_fold_left_77 _f_78 >> fun _gen_bind_86 -> _gen_bind_86 _a_83)
              >> fun _gen_bind_85 -> _gen_bind_85 _ys_82))
...
let rec _fold_right_87 _f_88 =
  value (fun _xs_89 ->
      value (fun _a_90 ->
          ...
          | [] -> value _a_90
          | _x_91 :: _xs_92 ->
              ( (_fold_right_87 _f_88 >> fun _gen_bind_95 -> _gen_bind_95 _xs_92)
...
let rec _iter_97 _f_98 =
  value (fun _gen_function_99 ->
      ...
      | _x_100 :: _xs_101 ->
          _f_98 _x_100 >> fun _ ->
          _iter_97 _f_98 >> fun _gen_bind_102 -> _gen_bind_102 _xs_101)
...
let rec _forall_103 _p_104 =
  value (fun _gen_function_105 ->
      ...
      | _x_106 :: _xs_107 -> (
          ...
          | true ->
              _forall_103 _p_104 >> fun _gen_bind_109 -> _gen_bind_109 _xs_107
          | false -> value false))
...
let rec _exists_110 _p_111 =
  value (fun _gen_function_112 ->
      ...
      | _x_113 :: _xs_114 -> (
          ...
          | true -> value true
          | false ->
              _exists_110 _p_111 >> fun _gen_bind_116 -> _gen_bind_116 _xs_114))

let _mem_117 _x_118 =
  _exists_110 (fun _x'_119 ->
...
let rec _filter_121 _p_122 =
  value (fun _gen_function_123 ->
      ...
      | _x_124 :: _xs_125 -> (
          ...
          | true ->
              (_filter_121 _p_122 >> fun _gen_bind_128 -> _gen_bind_128 _xs_125)
              >> fun _gen_bind_127 -> value (_x_124 :: _gen_bind_127)
          | false ->
              _filter_121 _p_122 >> fun _gen_bind_129 -> _gen_bind_129 _xs_125))
...
let _reverse_140 _lst_141 =
  let rec _reverse_acc_142 _acc_143 =
    value (fun _gen_function_144 ->
        ...
        | [] -> value _acc_143
        | _x_145 :: _xs_146 ->
            _reverse_acc_142 (_x_145 :: _acc_143) >> fun _gen_bind_147 ->
            _gen_bind_147 _xs_146)
  in
  _reverse_acc_142 [] >> fun _gen_bind_148 -> _gen_bind_148 _lst_141
...
let rec _var_149 (* @ *) _xs_150 =
  value (fun _ys_151 ->
      ...
      | [] -> value _ys_151
      | _x_152 :: _xs_153 ->
          ( _var_149 (* @ *) _xs_153 >> fun _gen_bind_155 ->
            _gen_bind_155 _ys_151 )
          >> fun _gen_bind_154 -> value (_x_152 :: _gen_bind_154))

let rec _length_156 _gen_let_rec_function_157 =
  match _gen_let_rec_function_157 with
  | [] -> value 0
  | _x_158 :: _xs_159 ->
      (_length_156 _xs_159 >> fun _gen_bind_161 -> _var_14 (* + *) _gen_bind_161)
      >> fun _gen_bind_160 -> _gen_bind_160 1
...
let _min_177 _x_178 =
  value (fun _y_179 ->
      ...
      >> fun _gen_bind_180 ->
      match _gen_bind_180 with true -> value _x_178 | false -> value _y_179)

let _max_182 _x_183 =
  value (fun _y_184 ->
      (_var_2 (* < *) _x_183 >> fun _gen_bind_186 -> _gen_bind_186 _y_184)
      >> fun _gen_bind_185 ->
      match _gen_bind_185 with true -> value _y_184 | false -> value _x_183)
...
let _print_endline_213 _v_214 =
  _to_string_40 _v_214 >> fun _s_215 ->
...
let rec _range_216 _n_217 =
  ...
  | 0 -> value []
  | _ ->
      (_var_16 (* - *) _n_217 >> fun _gen_bind_219 -> _gen_bind_219 1)
      >> fun _n1_218 ->
    ...
    handler
      {
        ...
        effect_clauses =
          (fun (type a b) (x : (a, b) effect) :
            ...
            match x with
            | Effect_Fetch ->
                fun (_ : unit) (_k_224 : int -> _ computation) -> _k_224 42
