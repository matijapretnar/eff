...
let rec _var_4 _xs_5 _ys_6 =
  ...
  | _x_7 :: _xs_8 ->
      let _gen_bind_9 =
        let _gen_bind_10 = _var_4 _xs_8 in
        _gen_bind_10 _ys_6
      in
      _x_7 :: _gen_bind_9
        ...
        (fun _y_24 ->
          value (fun _s_25 ->
              ...
              | _ ->
                  ...
                  value (_absurd_1 _gen_bind_26)));
      effect_clauses =
        (fun (type a b) (x : (a, b) effect) : (a -> (b -> _) -> _) ->
          match x with
          | Effect_Symbol ->
              fun (_c_14 : string) (_k_15 : string -> _) ->
                value (fun _s_16 ->
                    match _s_16 with
                    | [] ->
                    ...
                    | _x_18 :: _xs_19 ->
                        let _gen_bind_20 =
                          ...
                          _gen_bind_21 _x_18
                        in
                        if _gen_bind_20 then
                          _k_15 _x_18 >> fun _gen_bind_22 -> _gen_bind_22 _xs_19
                        else
  ...
  handler
    {
      ...
      effect_clauses =
        (fun (type a b) (x : (a, b) effect) : (a -> (b -> _) -> _) ->
          match x with
          | Effect_Decide ->
              fun (_ : unit) (_k_28 : bool -> _) ->
                (_k_28 true >> fun _gen_bind_30 -> value (_var_4 _gen_bind_30))
                >> fun _gen_bind_29 ->
                _k_28 false >> fun _gen_bind_31 ->
                  ...
                  handler
                    {
                      ...
                      effect_clauses =
                        (fun (type a b) (x : (a, b) effect) :
                          ...
                          match x with
                          | Effect_Fail ->
                              fun (_ : unit) (_ : unit -> _) -> _k_34 false
                          | eff' -> fun arg k -> Call (eff', arg, k));
                    }
                    comp)
                  (_k_34 true)
...
let _createNumber_35 (_prev_36, _num_37) =
  let _gen_bind_38 =
    let _gen_bind_39 =
      let _gen_bind_40 = _var_12 _prev_36 in
      _gen_bind_40 10
    in
    _var_11 _gen_bind_39
  in
...
let _digit_58 () =
  ...
  let rec _checkNums_60 _n_61 =
    match _n_61 with
    | [] ->
        (effect Effect_Fail) () >> fun _gen_bind_62 ->
        value (_absurd_1 _gen_bind_62)
    | _x_63 :: _xs_64 ->
        (effect Effect_Decide) () >> fun _gen_bind_65 ->
        if _gen_bind_65 then (effect Effect_Symbol) _x_63
...
let rec _many_66 _m_67 =
  ...
  if _gen_bind_68 then _m_67 () else value []

let rec _many1_69 () =
  _digit_58 () >> fun _x_70 ->
  _many_66 _many1_69 >> fun _xs_71 ->
  value
    (let _gen_bind_72 = _var_4 [ _x_70 ] in
     _gen_bind_72 _xs_71)
...
let rec _expr_73 () =
  let rec _term_74 () =
    let rec _factor_75 () =
      ...
      if _gen_bind_76 then _many1_69 () >> fun _i_77 -> value (_toNum_56 _i_77)
      else
