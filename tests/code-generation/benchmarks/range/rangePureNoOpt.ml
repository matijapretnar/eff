...
let _failwith_10 = ((fun _msg_11 ->
   ...
   fun _gen_bind_12 ->  value ((_absurd_8 _gen_bind_12))))
...
let _mod_18 = ((fun _m_19 ->  (fun _n_20 ->
   (match _n_20 with | 0 ->
                        ((effect Effect_DivisionByZero) ()) >>
                        fun _gen_bind_21 ->  value ((_absurd_8 _gen_bind_21))
                     | _n_22 ->
                        value ((let _gen_bind_23 = (_mod_17 _m_19) in
                     _gen_bind_23
                     _n_22))))))
...
let _var_31 (* / *) = ((fun _m_32 ->  (fun _n_33 ->
   (match _n_33 with | 0 ->
                        ((effect Effect_DivisionByZero) ()) >>
                        fun _gen_bind_34 ->  value ((_absurd_8 _gen_bind_34))
                     | _n_35 ->
                        value ((let _gen_bind_36 = (_var_29 (* / *) _m_32) in
                     _gen_bind_36
                     _n_35))))))
...
let rec _assoc_41 = fun _x_42 ->
   ...
   (match _gen_function_43 with | [] ->
                                ...
                                | (((_y_44, _z_45)) :: (_lst_46)) ->
                                   let _gen_bind_47 =
                                       (let _gen_bind_48 = (_var_1 (* = *)
                                            _x_42) in _gen_bind_48 _y_44) in
                                (if _gen_bind_47 then ((Some _z_45)) else let 
                                _gen_bind_49 = (_assoc_41 _x_42) in
                                _gen_bind_49
                                _lst_46)))
...
let _not_50 = ((fun _x_51 ->
   (if _x_51 then false else true)))

;;

let rec _range_52 = fun _m_53 ->
   (fun _n_54 ->
   let _gen_bind_55 = (let _gen_bind_56 = (_var_3 (* > *) _m_53) in
       _gen_bind_56 _n_54) in
(if _gen_bind_55 then [] else let _r_57 = (_range_52) in
let _gen_bind_58 =
    (let _gen_bind_59 =
         (let _gen_bind_60 = (let _gen_bind_61 = (_var_14 (* + *) _m_53) in
              _gen_bind_61 1) in _r_57 _gen_bind_60) in _gen_bind_59 _n_54)
    in (((::) (_m_53, _gen_bind_58)))))

;;

let rec _map_62 = fun _f_63 ->
   (fun _gen_function_64 ->
...
let _ignore_70 = ((fun _ ->  ()))

;;

let _take_71 = ((fun _f_72 ->
   (fun _k_73 ->
   let _r_74 = (let _gen_bind_75 = (_range_52 0) in _gen_bind_75 _k_73) in
let _gen_bind_76 = (_map_62 _f_72) in _gen_bind_76 _r_74)))

;;


let rec _fold_left_77 = fun _f_78 ->  (fun _a_79 ->  (fun _gen_function_80 ->
   (match _gen_function_80 with | [] ->
                                ...
                                | ((_y_81) :: (_ys_82)) ->
                                   ...
                                   fun _a_83 ->
                                      let _gen_bind_85 =
                                          (let _gen_bind_86 = (_fold_left_77
                                               _f_78) in _gen_bind_86 _a_83)
                                          in
                                   _gen_bind_85 _ys_82)))
...
let rec _fold_right_87 = fun _f_88 ->  (fun _xs_89 ->  (fun _a_90 ->
   (match _xs_89 with | [] ->
                         value ((_a_90))
                      | ((_x_91) :: (_xs_92)) ->
                         (let _gen_bind_94 =
                              (let _gen_bind_95 = (_fold_right_87 _f_88) in
                              _gen_bind_95 _xs_92) in _gen_bind_94 _a_90) >>
                         fun _a_93 ->
                            (_f_88 _x_91) >>
...
let rec _iter_97 = fun _f_98 ->  (fun _gen_function_99 ->
...
let rec _forall_103 = fun _p_104 ->  (fun _gen_function_105 ->
   (match _gen_function_105 with | [] ->
                                    value ((true))
                                 | ((_x_106) :: (_xs_107)) ->
                                    (_p_104 _x_106) >>
                                    fun _gen_bind_108 ->
                                       (if _gen_bind_108 then let _gen_bind_109 =
                                                                  (_forall_103
                                                                  _p_104) in
                                    _gen_bind_109
                                    _xs_107 else value ((false)))))

;;


let rec _exists_110 = fun _p_111 ->  (fun _gen_function_112 ->
   (match _gen_function_112 with | [] ->
                                    value ((false))
                                 | ((_x_113) :: (_xs_114)) ->
                                    (_p_111 _x_113) >>
                                    fun _gen_bind_115 ->
                                       (if _gen_bind_115 then value ((true)) else let 
                                    _gen_bind_116 = (_exists_110 _p_111) in
                                    _gen_bind_116 _xs_114)))

;;


let _mem_117 = ((fun _x_118 ->  _exists_110
((* both *)fun _lift_fun_1 -> value ((fun _x'_119 ->
   let _gen_bind_120 = (_var_1 (* = *) _x_118) in _gen_bind_120
_x'_119) _lift_fun_1))))

;;

let rec _filter_121 = fun _p_122 ->
   (fun _gen_function_123 ->
   (match _gen_function_123 with | [] ->
                                    value (([]))
                                 | ((_x_124) :: (_xs_125)) ->
                                    (_p_122 _x_124) >>
                                    fun _gen_bind_126 ->
                                       (if _gen_bind_126 then (let _gen_bind_128 =
                                                                   (_filter_121
                                                                   _p_122) in
                                                              _gen_bind_128
                                                              _xs_125) >>
                                                              fun _gen_bind_127 ->
                                                                 value (((((::) (
                                                              _x_124, 
                                                              _gen_bind_127))))) else let 
                                    _gen_bind_129 = (_filter_121 _p_122) in
                                    _gen_bind_129 _xs_125)))

;;


let rec _zip_130 = fun _xs_131 ->  (fun _ys_132 ->
   (match (_xs_131, _ys_132) with | ([], []) ->
                                     value (([]))
                                  | (((_x_133) :: (_xs_134)), 
                                     ((_y_135) :: (_ys_136))) ->
                                     (let _gen_bind_138 = (_zip_130 _xs_134)
                                          in _gen_bind_138 _ys_136) >>
                                     fun _gen_bind_137 ->
                                        value (((((::) ((_x_133, _y_135), 
                                                        _gen_bind_137)))))
                                  | (_, _) ->
                                     ...
                                     "zip: length mismatch") >>
                                     fun _gen_bind_139 ->  value ((_absurd_8
                                     _gen_bind_139))))
...
let _reverse_140 = ((fun _lst_141 ->
   let rec _reverse_acc_142 = fun _acc_143 ->  (fun _gen_function_144 ->
...
let rec _var_149 (* @ *) = fun _xs_150 ->
   ...
   (match _xs_150 with | [] ->
                       ...
                       | ((_x_152) :: (_xs_153)) ->
                          let _gen_bind_154 =
                              (let _gen_bind_155 = (_var_149 (* @ *) _xs_153)
                                   in _gen_bind_155 _ys_151) in
...
let _head_162 = ((fun _gen_function_163 ->
   (match _gen_function_163 with | [] ->
                                    ((effect Effect_InvalidArgument)
                                    "head: empty list") >>
                                    fun _gen_bind_164 ->  value ((_absurd_8
                                    _gen_bind_164))
                                 | ((_x_165) :: (_)) ->
                                    value ((_x_165)))))
...
let _tail_166 = ((fun _gen_function_167 ->
   (match _gen_function_167 with | [] ->
                                    ((effect Effect_InvalidArgument)
                                    "tail: empty list") >>
                                    fun _gen_bind_168 ->  value ((_absurd_8
                                    _gen_bind_168))
                                 | ((_x_169) :: (_xs_170)) ->
                                    value ((_xs_170)))))
...
let _abs_173 = ((fun _x_174 ->
   let _gen_bind_175 = (let _gen_bind_176 = (_var_2 (* < *) _x_174) in
       _gen_bind_176 0) in (if _gen_bind_175 then _var_13 (* ~- *)
_x_174 else _x_174)))

;;

let _min_177 = ((fun _x_178 ->  (fun _y_179 ->
   let _gen_bind_180 = (let _gen_bind_181 = (_var_2 (* < *) _x_178) in
       _gen_bind_181 _y_179) in
(if _gen_bind_180 then _x_178 else _y_179))))

;;


let _max_182 = ((fun _x_183 ->  (fun _y_184 ->
   let _gen_bind_185 = (let _gen_bind_186 = (_var_2 (* < *) _x_183) in
       _gen_bind_186 _y_184) in
...
let _odd_187 = ((fun _x_188 ->
   ((let _gen_bind_191 = (_mod_18 _x_188) in _gen_bind_191 2) >>
...
let _even_192 = ((fun _x_193 ->
   ((let _gen_bind_196 = (_mod_18 _x_193) in _gen_bind_196 2) >>
...
let _id_197 = ((fun _x_198 ->  _x_198))

;;


let _compose_199 = ((fun _f_200 ->  (fun _g_201 ->  (fun _x_202 ->
   (_g_201 _x_202) >> fun _gen_bind_203 ->  _f_200 _gen_bind_203))))

;;


let _fst_204 = ((fun (_x_205, _) ->  _x_205))

;;


let _snd_206 = ((fun (_, _y_207) ->  _y_207))

;;


let _print_208 = ((fun _v_209 ->  let _s_210 = (_to_string_40 _v_209) in
(effect Effect_Print) _s_210))

;;

let _print_string_211 = ((fun _str_212 ->
   (effect Effect_Print) _str_212))
