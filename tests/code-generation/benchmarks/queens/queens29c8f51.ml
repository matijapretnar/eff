...
let _available_273 = (fun (_number_of_queens_274, _x_275, _qs_276) ->
   let rec _loop_277 = fun (_possible_278, _y_279) ->  (match Pervasives.(<)
           _y_279
           1 with | true ->
                     value _possible_278
                  | false ->
                        ...
                        fun _gen_bind_283 ->
                           ...
                           fun _gen_bind_282 ->
                              (match _gen_bind_282 with | true ->
                                                        ...
                                                        (_possible_278,
                                                         Pervasives.(-)
                                                         _y_279 1))) in _loop_277
([], _number_of_queens_274))
...
let rec _choose_289 = fun _gen_let_rec_function_290 ->
   (match _gen_let_rec_function_290 with | [] ->
                                            call Effect_Fail () (fun _result_81 ->
                                                                    (match _result_81 with _ -> assert false))
                                         | ((_x_292) :: (_xs_293)) ->
...
let _magichandler_295 = { value_clause = (fun _y_298 ->  value (fun _ ->
                                             value _y_298));
                         finally_clause = (fun _gen_id_par_297 ->
                                              value _gen_id_par_297);
                         effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_Fail -> (fun (_ :  unit) (_ : unit -> _ computation) -> value (fun _k_296 ->
                            _k_296
...
let _backtrack_299 = { value_clause = (fun _gen_id_par_303 ->
                                          value _gen_id_par_303);
                      finally_clause = (fun _gen_id_par_302 ->
                                           value _gen_id_par_302);
                      effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_Decide -> (fun (_ :  unit) (_k_300 :  bool -> _ computation) ->
                      (handle { value_clause = (fun _y_86 ->  value (fun _ ->
                                                   value _y_86));
                               finally_clause = (fun _gen_id_par_85 ->
                                                    value _gen_id_par_85);
                               effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_Fail -> (fun (_ :  unit) (_ : unit -> _ computation) -> value (fun _k_87 ->
                                  _k_87
                               false)) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) } (_k_300
                      true)) >> fun _gen_bind_301 ->  _gen_bind_301 _k_300) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) }
...
let _queens_one_322 = (fun _number_of_queens_323 ->
   let rec _place_98 = fun (_x_100, _qs_99) ->  (match Pervasives.(>) _x_100
           _number_of_queens_323 with | true ->
                                         value _qs_99
                                      | false ->
                                         (_available_273
                                         (_number_of_queens_323, _x_100,
                                          _qs_99)) >>
                                         fun _gen_bind_101 ->
                                            (_choose_289 _gen_bind_101) >>
                                            fun _y_102 ->  _place_98
                                            (Pervasives.(+) _x_100 1,
                                             ((::) ((_x_100, _y_102), _qs_99)))) in let rec
_newvar_104 = fun (_x_100, _qs_99) ->  (match Pervasives.(>) _x_100
_number_of_queens_323 with | true ->
                              value _qs_99
                           | false ->
                              (_available_273
                              (_number_of_queens_323, _x_100, _qs_99)) >>
                              fun _gen_bind_101 ->
                                 let rec _newvar_155 = fun _gen_let_rec_function_290 ->
                                            (match _gen_let_rec_function_290 with
                                         | [] ->
                                            call Effect_Fail () (fun _result_169 ->
                                                                    ((match _result_169 with _ -> assert false))
                                                                    >>
                                                                    fun _y_163 ->
                                                                     _newvar_104
                                                                    (
                                         ...
                                         | ((_x_292) :: (_xs_293)) ->
                                            (handle { value_clause = (
                                                     ...
                                                     finally_clause = (
                                                     fun _gen_id_par_250 ->
                                                        value _gen_id_par_250);
                                                     effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_Fail -> (fun (_ :  unit) (_ : unit -> _ computation) -> value (fun _k_252 ->
                                                        _k_252
                                                     false)) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) } (_newvar_104
                                            (Pervasives.(+) _x_100 1,
                                             ((::) ((_x_100, _x_292), _qs_99)))))
                                            >>
                                            fun _gen_bind_249 ->
                                               _gen_bind_249
                                            (fun _result_177 ->
                                               (match _result_177 with
                                            | true ->
                                               _newvar_104
                                            (Pervasives.(+) _x_100 1,
                                             ((::) ((_x_100, _x_292), _qs_99)))
                                            | false ->
                                               let rec _newvar_199 = fun _gen_let_rec_function_290 ->
                                                          (match _gen_let_rec_function_290 with
                                                       | [] ->
                                                          call Effect_Fail () (
                                                       fun _result_213 ->
                                                          ((match _result_213 with _ -> assert false))
                                                          >>
                                                          fun _y_207 ->
                                                             _newvar_104
                                                          (Pervasives.(+)
                                                       ...
                                                       | ((_x_292) :: (_xs_293)) ->
                                                          (handle { value_clause = (
                                                                   ...
                                                                   finally_clause = (
                                                                   fun _gen_id_par_245 ->
                                                                     value _gen_id_par_245);
                                                                   effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_Fail -> (fun (_ :  unit) (_ : unit -> _ computation) -> value (fun _k_247 ->
                                                                     _k_247
                                                                   false)) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) } (_newvar_104
                                                          (Pervasives.(+)
                                                           _x_100 1,
                                                          ...
                                                          | false ->
                                                             _newvar_199
                                                          _xs_293))) in _newvar_199
                                            _xs_293))) in _newvar_155
                              _gen_bind_101) in _newvar_104 (1, []))

;;


let _queens_all_324 = (fun _number_of_queens_325 ->
   let rec _place_260 = fun (_x_262, _qs_261) ->  (match Pervasives.(>)
           _x_262
           _number_of_queens_325 with | true ->
                                         value _qs_261
                                      | false ->
                                         (_available_273
                                         (_number_of_queens_325, _x_262,
                                          _qs_261)) >>
                                         fun _gen_bind_263 ->
                                            (_choose_289 _gen_bind_263) >>
                                            fun _y_264 ->  _place_260
                                            (Pervasives.(+) _x_262 1,
                                             ((::) ((_x_262, _y_264), _qs_261)))) in let rec
_newvar_266 = fun (_x_262, _qs_261) ->  (match Pervasives.(>) _x_262
_number_of_queens_325 with | true ->
                              value (((::) (_qs_261, [])))
                           | false ->
                              (_available_273
                              (_number_of_queens_325, _x_262, _qs_261)) >>
                              fun _gen_bind_263 ->
                                 let rec _newvar_310 = fun _gen_let_rec_function_290 ->
                                            (match _gen_let_rec_function_290 with
                                         | [] ->
                                            value []
                                         | ((_x_292) :: (_xs_293)) ->
                                            (_newvar_266
                                            (Pervasives.(+) _x_262 1,
                                             ((::) ((_x_262, _x_292), _qs_261))))
                                            >>
                                            fun _gen_bind_405 ->
                                               (_var_165 (* @ *)
                                               _gen_bind_405) >>
                                               fun _gen_bind_406 ->
                                                  (let rec _newvar_355 = fun _gen_let_rec_function_290 ->
                                                              (match _gen_let_rec_function_290 with
                                                           | [] ->
                                                              value []
                                                           | ((_x_292) :: (_xs_293)) ->
                                                              ...
                                                              fun _gen_bind_401 ->
                                                                 ...
                                                                 fun _gen_bind_402 ->
                                                                    ...
                                                                    fun _gen_bind_403 ->
                                                                     _gen_bind_402
                                                                    _gen_bind_403) in _newvar_355
                                                  _xs_293) >>
                                                  fun _gen_bind_407 ->
                                                     _gen_bind_406
                                                  _gen_bind_407) in _newvar_310
                              _gen_bind_263) in _newvar_266
(1, []))
