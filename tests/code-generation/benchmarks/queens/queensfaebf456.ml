...
let _backtrack_295 = { value_clause = (fun _gen_id_par_300 ->
                                          value _gen_id_par_300);
                      finally_clause = (fun _gen_id_par_299 ->
                                           value _gen_id_par_299);
                      effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_Decide -> (fun (_ :  unit) (_k_296 :  bool -> _ computation) -> handle {
                       value_clause = (fun _gen_id_par_298 ->
                                          value _gen_id_par_298);
                      finally_clause = (fun _gen_id_par_297 ->
                                           value _gen_id_par_297);
                      effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_Fail -> (fun (_ :  unit) (_ : unit -> _ computation) -> _k_296
                      false) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) } (_k_296
                      true)) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) }

;;


let _choose_all_301 = { value_clause = (fun _x_307 ->
                                           value (((::) (_x_307, []))));
                       finally_clause = (fun _gen_id_par_306 ->
                                            value _gen_id_par_306);
                       effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_Decide -> (fun (_ :  unit) (_k_302 :  bool -> _ computation) ->
                       (_k_302 true) >>
                       fun _gen_bind_304 ->
                          (_var_165 (* @ *) _gen_bind_304) >>
                          fun _gen_bind_303 ->
                             (_k_302 false) >>
                             fun _gen_bind_305 ->  _gen_bind_303
                             _gen_bind_305) | Effect_Fail -> (fun (_ :  unit) (_ : unit -> _ computation) -> value []) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) }

;;


let _queens_308 = (fun _number_of_queens_309 ->
   let rec _place_310 = fun (_x_311, _qs_312) ->  (match Pervasives.(>)
           _x_311
           _number_of_queens_309 with | true ->
                                         value _qs_312
                                      | false ->
                                         (_available_273
                                         (_number_of_queens_309, _x_311,
                                          _qs_312)) >>
                                         fun _gen_bind_316 ->
                                            (_choose_289 _gen_bind_316) >>
                                            fun _y_315 ->  _place_310
                                            (Pervasives.(+) _x_311 1,
                                             ((::) ((_x_311, _y_315), _qs_312)))) in _place_310
(1, []))

;;

let _queens_one_319 = (fun _number_of_queens_320 ->
   let rec _place_93 = fun (_x_95, _qs_94) ->  (match Pervasives.(>) _x_95
           _number_of_queens_320 with | true ->
                                         value _qs_94
                                      | false ->
                                         (_available_273
                                         (_number_of_queens_320, _x_95,
                                          _qs_94)) >>
                                         fun _gen_bind_96 ->
                                            (_choose_289 _gen_bind_96) >>
                                            fun _y_97 ->  _place_93
                                            (Pervasives.(+) _x_95 1,
...
_number_of_queens_320 with | true ->
                           ...
                           | false ->
                              (_available_273
                              (_number_of_queens_320, _x_95, _qs_94)) >>
                              fun _gen_bind_96 ->
                                 let rec _newvar_136 = fun _gen_let_rec_function_290 ->
                                            (match _gen_let_rec_function_290 with
                                         | [] ->
                                            call Effect_Fail () (fun _result_148 ->
                                                                    ((match _result_148 with _ -> assert false))
                                                                    >>
                                                                    fun _y_144 ->
                                                                     _newvar_99
                                                                    (
                                         ...
                                         | ((_x_292) :: (_xs_293)) ->
                                            handle { value_clause = (
                                                    fun _gen_id_par_172 ->
                                                       value _gen_id_par_172);
                                                    finally_clause = (
                                                    fun _gen_id_par_171 ->
                                                       value _gen_id_par_171);
                                                    effect_clauses = (fun (type a) (type b) (x : (a, b) effect) ->
             ((match x with | Effect_Fail -> (fun (_ :  unit) (_ : unit -> _ computation) -> _newvar_136
                                                    _xs_293) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) } (_newvar_99
                                         (Pervasives.(+) _x_95 1,
                                          ((::) ((_x_95, _x_292), _qs_94))))) in _newvar_136
                              _gen_bind_96) in _newvar_99 (1, []))

;;


let _queens_all_321 = (fun _number_of_queens_322 ->
   let rec _place_180 = fun (_x_182, _qs_181) ->  (match Pervasives.(>)
           _x_182
           _number_of_queens_322 with | true ->
                                         value _qs_181
                                      | false ->
                                         (_available_273
                                         (_number_of_queens_322, _x_182,
                                          _qs_181)) >>
                                         fun _gen_bind_183 ->
                                            (_choose_289 _gen_bind_183) >>
                                            fun _y_184 ->  _place_180
                                            (Pervasives.(+) _x_182 1,
                                             ((::) ((_x_182, _y_184), _qs_181)))) in let rec
_newvar_186 = fun (_x_182, _qs_181) ->  (match Pervasives.(>) _x_182
_number_of_queens_322 with | true ->
                              value (((::) (_qs_181, [])))
                           | false ->
                              (_available_273
                              (_number_of_queens_322, _x_182, _qs_181)) >>
                              fun _gen_bind_183 ->
                                 let rec _newvar_230 = fun _gen_let_rec_function_290 ->
                                            (match _gen_let_rec_function_290 with
                                         | [] ->
                                            value []
                                         | ((_x_292) :: (_xs_293)) ->
                                            ...
                                            fun _gen_bind_276 ->
                                               ...
                                               fun _gen_bind_277 ->
                                                  ...
                                                  fun _gen_bind_278 ->
                                                     _gen_bind_277
                                                  _gen_bind_278) in _newvar_230
                              _gen_bind_183) in _newvar_186
(1, []))
