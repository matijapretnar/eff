...
let rec _loop_pure_5 _n_6 =
  let _gen_bind_7 = let _gen_bind_8 = _var_1 _n_6  in _gen_bind_8 0  in
  if _gen_bind_7
  then ()
  else
    (let _gen_bind_9 = let _gen_bind_10 = _var_3 _n_6  in _gen_bind_10 1  in
...
let rec _loop_latent_13 _n_14 =
  let _gen_bind_15 = let _gen_bind_16 = _var_1 _n_14  in _gen_bind_16 0  in
  if _gen_bind_15
  then value ()
  else
    (let _gen_bind_17 = let _gen_bind_18 = _var_2 _n_14  in _gen_bind_18 0
        in
     if _gen_bind_17
     then
       ((effect Effect_Fail) ()) >>
       ...
       (let _gen_bind_20 = let _gen_bind_21 = _var_3 _n_14  in _gen_bind_21 1
           in
...
let rec _loop_incr_24 _n_25 =
  let _gen_bind_26 = let _gen_bind_27 = _var_1 _n_25  in _gen_bind_27 0  in
  if _gen_bind_26
  then value ()
  else
    ((effect Effect_Incr) ()) >>
      ((fun _  ->
          let _gen_bind_28 =
            let _gen_bind_29 = _var_3 _n_25  in _gen_bind_29 1  in
  ...
  handler
    {
      value_clause =
        (fun _y_36  ->
           value
             (fun _lift_fun_1  -> value ((fun _x_37  -> _x_37) _lift_fun_1)));
