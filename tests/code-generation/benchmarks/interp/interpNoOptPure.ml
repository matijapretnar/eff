            ...
            value
              (fun _v_64  ->
                 ...
                 ((effect Effect_SetEnv) _ext_65) >>
                   (fun _ext_66  ->
                      let _gen_bind_67 = _interpT_60 _t_62  in
            ...
            value
              (fun _v_71  ->
                 ...
                 ((effect Effect_SetEnv) _ext_72) >>
                   (fun _ext_73  ->
                      let _gen_bind_74 = _interpT_60 _t_69  in
  ...
  handler
    {
      value_clause =
        (fun _y_154  ->
           fun _lift_fun_1  -> value ((fun _  -> _y_154) _lift_fun_1));
      effect_clauses = fun (type a) -> fun (type b) ->
        fun (x : (a,b) effect)  ->
          (match x with
           | Effect_LookupLoc  ->
                  ...
                  fun (_k_150 : int -> _)  ->
                    fun _s_151  ->
                      ((_lookupState_16 (_x_149, _s_151)) >>
                         (fun _gen_bind_153  -> value (_k_150 _gen_bind_153)))
                        >> (fun _gen_bind_152  -> _gen_bind_152 _s_151))
           | Effect_UpdateLoc  ->
               (fun ((_x_143,_y_144) : (loc* int))  ->
                  fun (_k_145 : loc -> _)  ->
                    fun _s_146  ->
                      let _gen_bind_147 = _k_145 _x_143  in
                      let _gen_bind_148 =
                  ...
                  fun (_k_139 : loc -> _)  ->
                    fun _s_140  ->
                      let _gen_bind_141 =
                        ...
                        _k_139 _gen_bind_142  in
                      _gen_bind_141 _s_140)
           | eff' -> (fun arg  -> fun k  -> Call (eff', arg, k)) : a ->
                                                                    (b -> _)
                                                                    -> 
                                                                    _)
...
File "_tmp/interp.eff.ml", line 369, characters 50-60:
