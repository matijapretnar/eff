...
let rec _var_9 _xs_10 _ys_11 =
  match _xs_10 with
  | [] -> _ys_11
  | _x_12::_xs_13 -> _x_12 :: (_var_9 _xs_13 _ys_11) 
type num = int
...
let rec _lookupState_16 (_x_17,_y_18) =
  ...
  | (_x'_20,_y_21)::_lst_22 ->
      if _x_17 = _x'_20
      then value _y_21
      else _lookupState_16 (_x_17, _lst_22)
...
let rec _checkLoc_29 (_x_30,_env_31) =
  ...
  | (_x'_32,_y_33)::_lst_34 ->
      if _x_30 = _x'_32 then true else _checkLoc_29 (_x_30, _lst_34)
  
let rec _createLoc_37 (_i_38,_env_39) =
  if _checkLoc_29 (_i_38, _env_39)
  then _createLoc_37 ((_i_38 + 1), _env_39)
  else _i_38 
...
let rec _lookupEnv_45 (_x_46,_y_47) =
  ...
  | (_x'_49,_y_50)::_lst_51 ->
      if _x_46 = _x'_49
      then value _y_50
      else _lookupState_16 (_x_46, _lst_51)
  ...
  | LambdaN (_s_61,_t_62) ->
      call Effect_ReadEnv ()
        (fun _result_14  ->
           value
             (fun _v_64  ->
                call Effect_SetEnv (_extendEnv_54 (_s_61, _v_64, _result_14))
                  (fun _result_11  ->
                     call Effect_InEnv (_result_11, (_interpT_60 _t_62))
  ...
  | LambdaV (_s_68,_t_69) ->
      call Effect_ReadEnv ()
        (fun _result_22  ->
           value
             (fun _v_71  ->
                call Effect_SetEnv (_extendEnv_54 (_s_68, _v_71, _result_22))
                  (fun _result_19  ->
                     call Effect_InEnv (_result_19, (_interpT_60 _t_69))
...
let rec _interp_86 _a_87 =
  ...
  | Add (_l_89,_r_90) ->
      (_interp_86 _l_89) >>
        ((fun _gen_bind_92  ->
            let _gen_bind_91 = (+) _gen_bind_92  in
            (_interp_86 _r_90) >>
              (fun _gen_bind_93  -> value (_gen_bind_91 _gen_bind_93))))
  | Mul (_l_94,_r_95) ->
      (_interp_86 _l_94) >>
        ((fun _gen_bind_97  ->
            let _gen_bind_96 = ( * ) _gen_bind_97  in
            (_interp_86 _r_95) >>
              (fun _gen_bind_98  -> value (_gen_bind_96 _gen_bind_98))))
  | Sub (_l_99,_r_100) ->
      (_interp_86 _l_99) >>
        ((fun _gen_bind_102  ->
            let _gen_bind_101 = (-) _gen_bind_102  in
            (_interp_86 _r_100) >>
  ...
  | Div (_l_104,_r_105) ->
      (_interp_86 _r_105) >>
        ((fun _r_num_106  ->
            ...
            | _ ->
                (_interp_86 _l_104) >>
                  ((fun _gen_bind_108  -> value (_gen_bind_108 / _r_num_106)))))
  | Ref _x_109 ->
      (_interp_86 _x_109) >>
        ((fun _x_interp_110  ->
            call Effect_AllocLoc ()
...
let rec _interpTopLevel_127 _lst_128 _results_129 =
  ...
  | _top_130::_tail_131 ->
      ...
      (_interp_86 _top_130) >>
        ((fun _gen_bind_135  -> _gen_bind_132 (_gen_bind_134 [_gen_bind_135])))
        ...
        fun (x : (a,b) effect)  ->
          (match x with
           | Effect_Arith_DivByZero  ->
               (fun (() : unit)  -> fun (_k_137 : int -> _)  -> value (- 1))
  ...
  handler
    {
      value_clause =
        (fun _y_154  ->
           fun _lift_fun_644  -> value ((fun _  -> _y_154) _lift_fun_644));
      effect_clauses = fun (type a) -> fun (type b) ->
        fun (x : (a,b) effect)  ->
          (match x with
           | Effect_LookupLoc  ->
                  ...
                  fun (_k_150 : int -> _)  ->
                    fun _s_151  ->
                      (_lookupState_16 (_x_149, _s_151)) >>
                        (fun _gen_bind_153  -> _k_150 _gen_bind_153 _s_151))
           | Effect_UpdateLoc  ->
           ...
           | Effect_AllocLoc  ->
               (fun (() : unit)  ->
                  fun (_k_139 : loc -> _)  ->
                    fun _s_140  -> _k_139 (_getNewLoc_43 _s_140) _s_140)
           | eff' -> (fun arg  -> fun k  -> Call (eff', arg, k)) : a ->
                                                                    (b -> _)
                                                                    -> 
                                                                    _)
  ...
  handler
    {
      value_clause =
        (fun _y_166  ->
           value
             (fun _lift_fun_645  -> value ((fun _  -> _y_166) _lift_fun_645)));
      effect_clauses = fun (type a) -> fun (type b) ->
        fun (x : (a,b) effect)  ->
          (match x with
           | Effect_InEnv  ->
...
let rec _createCase_173 _n_174 =
  match _n_174 with
  | 1 -> _testCaseD_172
  | _ -> App (_lambdaCase_167, (_createCase_173 (_n_174 - 1))) 
let _finalCase_178 = _createCase_173 200 
let _bigTest_179 () =
  (_storeHandler_138
     ((let rec _newvar_80 _a_87 =
         match _a_87 with
         | Num _b_88 -> value (fun _  -> _b_88)
         | Add (_l_89,_r_90) ->
             ((fun comp  ->
                 handler
                   {
                     value_clause =
                       (fun _gen_bind_161  ->
                          let _gen_bind_162 = (+) _gen_bind_161  in
                          (fun comp  ->
                             handler
                               {
                                 value_clause =
                                   (fun _gen_bind_163  ->
                                      let _y_164 =
                                        _gen_bind_162 _gen_bind_163  in
                                      fun _  -> _y_164);
                                     ...
                                     (match x with
                                      | Effect_InEnv  ->
                                          (fun
                                             ...
                                             fun (_k_165 : int -> _)  ->
                                               fun _  ->
                                                 _k_165 _s_166 _env_167)
                                      | Effect_ReadEnv  ->
                                          (fun (() : unit)  ->
                                             fun (_k_168 : env -> _)  ->
                                               fun _env_169  ->
                                                 _k_168 _env_169 _env_169)
                                      | Effect_SetEnv  ->
                                          (fun (_env_171 : env)  ->
                                             fun (_k_170 : env -> _)  ->
                                               fun _  ->
                                                 _k_170 _env_171 _env_171)
                                      | eff' ->
                                          (fun arg  ->
                                             fun k  -> Call (eff', arg, k)) : 
                                     a -> (b -> _) -> _)
                               } comp) (_interp_86 _r_90));
                     effect_clauses = fun (type a) -> fun (type b) ->
                       fun (x : (a,b) effect)  ->
                         (match x with
                          | Effect_InEnv  ->
                              (fun ((_env_174,_s_173) : (env* int))  ->
                                 fun (_k_172 : int -> _)  ->
                                   value (fun _  -> _k_172 _s_173 _env_174))
                          | Effect_ReadEnv  ->
                              (fun (() : unit)  ->
                                 fun (_k_175 : env -> _)  ->
                                   value
                                     (fun _env_176  ->
                                        _k_175 _env_176 _env_176))
                          | Effect_SetEnv  ->
                              (fun (_env_178 : env)  ->
                                 fun (_k_177 : env -> _)  ->
                                   value (fun _  -> _k_177 _env_178 _env_178))
                          | eff' ->
                              (fun arg  -> fun k  -> Call (eff', arg, k)) : 
                         a -> (b -> _) -> _)
                   } comp)) (_interp_86 _l_89)
         | Mul (_l_94,_r_95) ->
             ((fun comp  ->
                 handler
                   {
                     value_clause =
                       (fun _gen_bind_227  ->
                          let _gen_bind_228 = ( * ) _gen_bind_227  in
                          (fun comp  ->
                             handler
                               {
                                 value_clause =
                                   (fun _gen_bind_229  ->
                                      let _y_230 =
                                        _gen_bind_228 _gen_bind_229  in
                                      fun _  -> _y_230);
                                 effect_clauses = fun (type a) -> fun (type
                                   b) ->
                                   fun (x : (a,b) effect)  ->
                                     (match x with
                                      | Effect_InEnv  ->
                                          (fun
                                             ...
                                             fun (_k_231 : int -> _)  ->
                                               fun _  ->
                                                 _k_231 _s_232 _env_233)
                                      | Effect_ReadEnv  ->
                                          (fun (() : unit)  ->
                                             fun (_k_234 : env -> _)  ->
                                               fun _env_235  ->
                                                 _k_234 _env_235 _env_235)
                                      | Effect_SetEnv  ->
                                          (fun (_env_237 : env)  ->
                                             fun (_k_236 : env -> _)  ->
                                               fun _  ->
                                                 _k_236 _env_237 _env_237)
                                      | eff' ->
                                          (fun arg  ->
                                             fun k  -> Call (eff', arg, k)) : 
                                     a -> (b -> _) -> _)
                               } comp) (_interp_86 _r_95));
                     effect_clauses = fun (type a) -> fun (type b) ->
                       fun (x : (a,b) effect)  ->
                         (match x with
                          | Effect_InEnv  ->
                              (fun ((_env_240,_s_239) : (env* int))  ->
                                 fun (_k_238 : int -> _)  ->
                                   value (fun _  -> _k_238 _s_239 _env_240))
                          | Effect_ReadEnv  ->
                              (fun (() : unit)  ->
                                 fun (_k_241 : env -> _)  ->
                                   value
                                     (fun _env_242  ->
                                        _k_241 _env_242 _env_242))
                          | Effect_SetEnv  ->
                              (fun (_env_244 : env)  ->
                                 fun (_k_243 : env -> _)  ->
                                   value (fun _  -> _k_243 _env_244 _env_244))
                          | eff' ->
                              (fun arg  -> fun k  -> Call (eff', arg, k)) : 
                         a -> (b -> _) -> _)
                   } comp)) (_interp_86 _l_94)
         | Sub (_l_99,_r_100) ->
             ((fun comp  ->
                 handler
                   {
                     value_clause =
                       (fun _gen_bind_293  ->
                          let _gen_bind_294 = (-) _gen_bind_293  in
                          (fun comp  ->
                             handler
                               {
                                 value_clause =
                                   (fun _gen_bind_295  ->
                                      let _y_296 =
                                        _gen_bind_294 _gen_bind_295  in
                                      fun _  -> _y_296);
                                 effect_clauses = fun (type a) -> fun (type
                                   b) ->
                                   fun (x : (a,b) effect)  ->
                                     (match x with
                                      | Effect_InEnv  ->
                                          (fun
                                             ...
                                             fun (_k_297 : int -> _)  ->
                                               fun _  ->
                                                 _k_297 _s_298 _env_299)
                                      | Effect_ReadEnv  ->
                                          (fun (() : unit)  ->
                                             fun (_k_300 : env -> _)  ->
                                               fun _env_301  ->
                                                 _k_300 _env_301 _env_301)
                                      | Effect_SetEnv  ->
                                          (fun (_env_303 : env)  ->
                                             fun (_k_302 : env -> _)  ->
                                               fun _  ->
                                                 _k_302 _env_303 _env_303)
                                      | eff' ->
                                          (fun arg  ->
                                             fun k  -> Call (eff', arg, k)) : 
                                     a -> (b -> _) -> _)
                               } comp) (_interp_86 _r_100));
                     effect_clauses = fun (type a) -> fun (type b) ->
                       fun (x : (a,b) effect)  ->
                         (match x with
                          | Effect_InEnv  ->
                              (fun ((_env_306,_s_305) : (env* int))  ->
                                 fun (_k_304 : int -> _)  ->
                                   value (fun _  -> _k_304 _s_305 _env_306))
                          | Effect_ReadEnv  ->
                              (fun (() : unit)  ->
                                 fun (_k_307 : env -> _)  ->
                                   value
                                     (fun _env_308  ->
                                        _k_307 _env_308 _env_308))
                          | Effect_SetEnv  ->
                              (fun (_env_310 : env)  ->
                                 fun (_k_309 : env -> _)  ->
                                   value (fun _  -> _k_309 _env_310 _env_310))
                          | eff' ->
                              (fun arg  -> fun k  -> Call (eff', arg, k)) : 
                         a -> (b -> _) -> _)
                   } comp)) (_interp_86 _l_99)
         | Div (_l_104,_r_105) ->
             ((fun comp  ->
                 handler
                   {
                         ...
                         (match x with
                          | Effect_InEnv  ->
                              (fun ((_env_382,_s_381) : (env* int))  ->
                                 fun (_k_380 : int -> _)  ->
                                   value (fun _  -> _k_380 _s_381 _env_382))
                          | Effect_ReadEnv  ->
                              (fun (() : unit)  ->
                                 fun (_k_383 : env -> _)  ->
                                   value
                                     (fun _env_384  ->
                                        _k_383 _env_384 _env_384))
                          | Effect_SetEnv  ->
                              (fun (_env_386 : env)  ->
                                 fun (_k_385 : env -> _)  ->
                                   value (fun _  -> _k_385 _env_386 _env_386))
                          | eff' ->
                              (fun arg  -> fun k  -> Call (eff', arg, k)) : 
                         a -> (b -> _) -> _)
                   } comp)) (_interp_86 _r_105)
         | Ref _x_109 ->
             ((fun comp  ->
                 handler
                   {
                         ...
                         (match x with
                          | Effect_InEnv  ->
                              (fun ((_env_407,_s_406) : (env* int))  ->
                                 fun (_k_405 : int -> _)  ->
                                   value (fun _  -> _k_405 _s_406 _env_407))
                          | Effect_ReadEnv  ->
                              (fun (() : unit)  ->
                                 fun (_k_408 : env -> _)  ->
                                   value
                                     (fun _env_409  ->
                                        _k_408 _env_409 _env_409))
                          | Effect_SetEnv  ->
                              (fun (_env_411 : env)  ->
                                 fun (_k_410 : env -> _)  ->
                                   value (fun _  -> _k_410 _env_411 _env_411))
                          | eff' ->
                              (fun arg  -> fun k  -> Call (eff', arg, k)) : 
                         a -> (b -> _) -> _)
                   } comp)) (_interp_86 _x_109)
         | Deref _x_112 ->
             ((fun comp  ->
                 handler
                   {
                         ...
                         (match x with
                          | Effect_InEnv  ->
                              (fun ((_env_428,_s_427) : (env* int))  ->
                                 fun (_k_426 : int -> _)  ->
                                   value (fun _  -> _k_426 _s_427 _env_428))
                          | Effect_ReadEnv  ->
                              (fun (() : unit)  ->
                                 fun (_k_429 : env -> _)  ->
                                   value
                                     (fun _env_430  ->
                                        _k_429 _env_430 _env_430))
                          | Effect_SetEnv  ->
                              (fun (_env_432 : env)  ->
                                 fun (_k_431 : env -> _)  ->
                                   value (fun _  -> _k_431 _env_432 _env_432))
                          | eff' ->
                              (fun arg  -> fun k  -> Call (eff', arg, k)) : 
                         a -> (b -> _) -> _)
                   } comp)) (_interp_86 _x_112)
         | Assign (_lhs_114,_rhs_115) ->
             ((fun comp  ->
                 handler
                   {
                                      ...
                                      | Effect_InEnv  ->
                                          (fun
                                             ...
                                             fun (_k_477 : int -> _)  ->
                                               value
                                                 (fun _  ->
                                                    _k_477 _s_478 _env_479))
                                      | Effect_ReadEnv  ->
                                          (fun (() : unit)  ->
                                             fun (_k_480 : env -> _)  ->
                                               value
                                                 (fun _env_481  ->
                                                    _k_480 _env_481 _env_481))
                                      | Effect_SetEnv  ->
                                          (fun (_env_483 : env)  ->
                                             fun (_k_482 : env -> _)  ->
                                               value
                                                 (fun _  ->
                                                    _k_482 _env_483 _env_483))
                                      | eff' ->
                                          (fun arg  ->
                                             fun k  -> Call (eff', arg, k)) : 
                                     a -> (b -> _) -> _)
                               } comp) (_interp_86 _rhs_115));
                     effect_clauses = fun (type a) -> fun (type b) ->
                       fun (x : (a,b) effect)  ->
                         (match x with
                          | Effect_InEnv  ->
                              (fun ((_env_486,_s_485) : (env* int))  ->
                                 fun (_k_484 : int -> _)  ->
                                   value (fun _  -> _k_484 _s_485 _env_486))
                          | Effect_ReadEnv  ->
                              (fun (() : unit)  ->
                                 fun (_k_487 : env -> _)  ->
                                   value
                                     (fun _env_488  ->
                                        _k_487 _env_488 _env_488))
                          | Effect_SetEnv  ->
                              (fun (_env_490 : env)  ->
                                 fun (_k_489 : env -> _)  ->
                                   value (fun _  -> _k_489 _env_490 _env_490))
                          | eff' ->
                              (fun arg  -> fun k  -> Call (eff', arg, k)) : 
                         a -> (b -> _) -> _)
                   } comp)) (_interp_86 _lhs_114)
         | Var _v_118 ->
             value
               (fun _env_509  ->
                  ((_lookupEnv_45 (_v_118, _env_509)) >>
                     (fun _y_500  -> value (fun _  -> _y_500))) _env_509)
         | App (_e1_120,_e2_121) ->
             value
               ((fun comp  ->
                   handler
                                             ...
                                             | eff' ->
                                                 (fun arg  ->
                                                    fun k  ->
                                                      Call (eff', arg, k)) : 
                                            a -> (b -> _) -> _)
                                      } comp) (_interp_86 _e2_121)) _env_617
                                _env_617);
                       effect_clauses = fun (type a) -> fun (type b) ->
                         fun (x : (a,b) effect)  ->
                           (match x with
                            | Effect_InEnv  ->
                                (fun ((_env_639,_s_638) : (env* int))  ->
                                   fun (_k_637 : int -> _)  ->
                                     fun _  -> _k_637 _s_638 _env_639)
                            | Effect_ReadEnv  ->
                                (fun (() : unit)  ->
                                   fun (_k_640 : env -> _)  ->
                                     fun _env_641  ->
                                       _k_640 _env_641 _env_641)
                            | Effect_SetEnv  ->
                                (fun (_env_643 : env)  ->
                                   fun (_k_642 : env -> _)  ->
                                     fun _  -> _k_642 _env_643 _env_643)
                            | eff' ->
                                (fun arg  -> fun k  -> Call (eff', arg, k)) : 
                           a -> (b -> _) -> _)
                     } comp) (_interpFunc_58 (_e1_120, _interp_86)))
          in
       _newvar_80 _finalCase_178) >> (fun _gen_bind_181  -> _gen_bind_181 [])))
    >> (fun _gen_bind_180  -> _gen_bind_180 [])
  
File "_tmp/interp.eff.ml", line 365, characters 50-60:
Error: This expression has type term -> loc computation
       but an expression was expected of type term -> int
       Type loc computation is not compatible with type int 
