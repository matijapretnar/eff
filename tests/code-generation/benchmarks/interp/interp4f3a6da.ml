...
let _bigTest_424 = (fun () ->
   (let rec _newvar_157 = fun _a_328 ->
               (match _a_328 with | (Num _b_329) ->
                                     value (fun _ ->
                                     value _b_329)
                                  | (Add (_l_330, _r_331)) ->
                                     handle { value_clause = (fun _gen_bind_289 ->
                                                                 let
                                                              _gen_bind_290 =
                                                              fun _x2_304 ->
                                                                 value (Pervasives.(+)
             ...
             ((match x with | Effect_InEnv -> (fun ((
                                  ...
                                  _l_330)
                                  | (Mul (_l_335, _r_336)) ->
                                     handle { value_clause = (fun _gen_bind_410 ->
                                                                 let
                                                              _gen_bind_411 =
                                                              fun _x2_425 ->
                                                                 value (Pervasives.( * )
             ...
             ((match x with | Effect_InEnv -> (fun ((
                                                              ...
                                                              _r_336));
                                             finally_clause = (fun _gen_id_par_409 ->
             ...
             ((match x with | Effect_InEnv -> (fun ((
                                  ...
                                  _l_335)
                                  | (Sub (_l_340, _r_341)) ->
                                     handle { value_clause = (fun _gen_bind_531 ->
                                                                 let
                                                              _gen_bind_532 =
                                                              fun _x2_546 ->
                                                                 value (Pervasives.(-)
             ...
             ((match x with | Effect_InEnv -> (fun ((
                                                              ...
                                                              _r_341));
                                             finally_clause = (fun _gen_id_par_530 ->
             ...
             ((match x with | Effect_InEnv -> (fun ((
                                  ...
                                  _l_340)
                                  | (Div (_l_345, _r_346)) ->
                                     handle { value_clause = (fun _r_num_644 ->
             ...
             ((match x with | Effect_InEnv -> (fun ((
                                                              ...
                                                              _l_345)));
                                             finally_clause = (fun _gen_id_par_643 ->
             ...
             ((match x with | Effect_InEnv -> (fun ((
                                  ...
                                  _r_346)
                                  | (Ref _x_350) ->
                                     handle { value_clause = (fun _x_interp_690 ->
                                                                 call Effect_AllocLoc () (
                                                              fun _result_691 ->
                                                                 call Effect_UpdateLoc (
                                                              _result_691,
                                                              ...
                                                              fun _result_692 ->
                                                                 value (fun _ ->
                                                                 value _result_692))));
                                             finally_clause = (fun _gen_id_par_689 ->
             ...
             ((match x with | Effect_InEnv -> (fun ((
                                  ...
                                  _x_350)
                                  | (Deref _x_353) ->
                                     handle { value_clause = (fun _x_interp_720 ->
                                                                 call Effect_LookupLoc _x_interp_720 (
                                                              fun _result_721 ->
                                                                 value (fun _ ->
                                                                 value _result_721)));
                                             finally_clause = (fun _gen_id_par_719 ->
             ...
             ((match x with | Effect_InEnv -> (fun ((
                                  ...
                                  _x_353)
                                  | (Assign (_lhs_355, _rhs_356)) ->
                                     handle { value_clause = (fun _x_loc_790 ->
                                                                 handle {
                                                               value_clause = (
                                                              fun _x_interp_792 ->
                                                                 call Effect_UpdateLoc (
             ...
             ((match x with | Effect_InEnv -> (fun ((
                                                              ...
                                                              _rhs_356));
                                             finally_clause = (fun _gen_id_par_789 ->
             ...
             ((match x with | Effect_InEnv -> (fun ((
                                  ...
                                  | (Var _v_359) ->
                                     value (fun _env_840 ->
                                     (_lookupEnv_286 (_v_359, _env_840)) >>
                                     fun _y_828 ->  value _y_828)
                                  | (App (_e1_361, _e2_362)) ->
                                     let rec _newvar_1043 = fun (_a_300,
                                                                 _interpT_301) ->
                                                (match _a_300 with | (LambdaN
                                                                   (_s_302,
                                                                    _t_303)) ->
                                                                     value (fun _env_1246 ->
   ...
   _finalCase_423) >>
   fun _gen_bind_426 ->
      (handle { value_clause = (fun _y_1746 ->  value (fun _ ->
                                   value _y_1746));
             ...
             ((match x with | Effect_LookupLoc -> (fun (_x_1748 :  loc) (_k_1747 :  int -> _ computation) -> value (fun _s_1749 ->
                  ...
                  fun _gen_bind_1750 ->
                     ...
                     fun _gen_bind_1751 ->  _gen_bind_1751 _s_1749)) | Effect_UpdateLoc -> (fun ((
               _x_1754, _y_1753) : ( loc*
                int)) (_k_1752 :  loc -> _ computation) -> value (fun _s_1755 ->
                  (_k_1752 _x_1754) >>
                  fun _gen_bind_1756 ->
                     (_updateState_266 (_x_1754, _y_1753, _s_1755)) >>
                     fun _gen_bind_1757 ->  _gen_bind_1756 _gen_bind_1757)) | Effect_AllocLoc -> (fun (() :  unit) (_k_1758 :  loc -> _ computation) -> value (fun _s_1759 ->
                  (_getNewLoc_284 _s_1759) >>
                  fun _gen_bind_1760 ->
                     (_k_1758 _gen_bind_1760) >>
                     fun _gen_bind_1761 ->  _gen_bind_1761 _s_1759)) | eff' -> fun arg k -> Call (eff', arg, k)) : a -> (b -> _ computation) -> _ computation)) } (_gen_bind_426
