...
let _mem_117 _x_118 =
  _exists_110
    (fun _x_34  -> value ((fun _x'_119  -> _x_118 = _x'_119) _x_34))
...
let rec _loop_216 _n_217 =
  match _n_217 < 0 with
  | true  ->
      call Effect_Fail () (fun _result_30  -> value (_absurd_8 _result_30))
  | false  ->
      (match _n_217 = 0 with
       | true  -> value 0
       | false  ->
           (_loop_216 (_n_217 - 1)) >>
             ((fun _gen_bind_224  -> value (_gen_bind_224 + 1))))
  
let rec _loop_acc_227 _n_228 _acc_229 =
  match _n_228 < 0 with
  | true  ->
      call Effect_Fail () (fun _result_33  -> value (_absurd_8 _result_33))
  | false  ->
      (match _n_228 = 0 with
       | true  -> value _acc_229
       | false  -> _loop_acc_227 (_n_228 - 1) (_acc_229 + 1))
