...
let () =
  ...
  Command.run (Bench.make_command [
      Bench.Test.create ~name:"Handlers - 7cc7606" (fun () -> Loop7cc7606._loop_281 number_of_loops);
      Bench.Test.create ~name:"Handlers - ce4263d" (fun () -> Loopce4263d._loop_279 number_of_loops);
  ...
  Command.run (Bench.make_command [
      Bench.Test.create ~name:"Handlers - 7cc7606" (fun () -> Loop7cc7606.run (Loop7cc7606._loop_acc_292 number_of_loops) 0);
      Bench.Test.create ~name:"Handlers - ce4263d" (fun () -> Loopce4263d.run (Loopce4263d._loop_acc_290 number_of_loops) 0);
