(* This file is based on OCaml's List library.
...
let rec length_aux len = function [] -> len | a :: l -> length_aux (len + 1) l
...
let stable_sort cmp l =
  let rec rev_merge l1 l2 accu =
    ...
    | h1 :: t1, h2 :: t2 ->
        if cmp h1 h2 <= 0 then rev_merge t1 l2 (h1 :: accu)
  ...
  let rec rev_merge_rev l1 l2 accu =
    ...
    | l1, [] -> rev_append l1 accu
    | h1 :: t1, h2 :: t2 ->
        if cmp h1 h2 > 0 then rev_merge_rev t1 l2 (h1 :: accu)
